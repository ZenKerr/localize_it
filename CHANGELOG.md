...
* Added support for trailing commas in all macros
...
* Explicitly split storage setters:
    * `set_from_usize` -> `set_from_usize` / `set_from_usize_or_default`
    * `set_from_str` -> `set_from_str` / `set_from_str_or_default`
    * `set_from_caseless_str` -> `set_from_caseless_str` / `set_from_caseless_str_or_default`
...
* Renamed storage functions:
    * `get` -> `get_locale`
    * `set` -> `set_locale`
    * `get_as_usize` -> `get_locale_as_usize`
    * `set_from_usize` -> `set_locale_from_usize`
    * `get_as_str` -> `get_locale_as_str`
    * `set_from_str` -> `set_locale_from_str`
    * `set_from_caseless_str` -> `set_locale_from_caseless_str`
